...
- 2026-07-03T02:30:00Z | FEATURE | tables everywhere — build_site.py now auto-generates place tables from frontmatter: borough pages (borough-scoped, Neighborhood col + category filter + search), neighborhood pages (neighborhood-scoped w/ aliases, Notes col + search), all sortable. Hand-maintained bullet listings replaced with [[PLACES_TABLE]] placeholders; adding a place now auto-updates every table.
- 2026-07-03T02:30:00Z | FEATURE | moved full searchable DB to its own page (database.md, [[DATABASE_TABLE]]); homepage + site nav link to it. Added neighborhood `aliases` (DUMBO→[DUMBO,Brooklyn Heights], Prospect Park→[Park Slope,Prospect Heights]) so sub-neighborhood places table correctly.
- 2026-07-03T02:30:00Z | STYLE | colorful 🌈🦄 background — pastel rainbow gradient + tiled unicorn/rainbow emoji pattern behind opaque cards (text stays readable)
- 2026-07-03T03:30:00Z | FEATURE | borough pages now group into one sortable table PER neighborhood (home-base first, then A–Z; unique table ids so each sorts independently; "Other / citywide" catch-all for unpaged-neighborhood places like NYPL)
- 2026-07-03T03:30:00Z | FEATURE | guide tables — rainy-day (tag=rainy-day) + free-activities (cost=free) render as generated tables via [[TABLE field=val]]; free-activities keeps its paid-museum free-hours + ferry narrative. Tagged all museums/indoor-play/library with rainy-day for complete coverage (32).
- 2026-07-03T03:30:00Z | FIX | table place-links use depth-correct prefix (../places/ from guides, places/ from root, sibling on borough/neighborhood pages)
