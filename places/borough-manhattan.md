...
tags: [borough]
---
The big-museum borough — Central Park, the waterfront parks, and classic
kid outings, an easy L-train or ferry ride from Williamsburg.

## Map

<iframe class="map-embed" src="../map/manhattan.html" title="Manhattan toddler map" loading="lazy"></iframe>

[Open the full-screen Manhattan map →](../map/manhattan.html)

## [Upper West Side](neighborhood-uws.md)

### 🎨 Museums
- [Children's Museum of Manhattan (CMOM)](museum-cmom.md) — `$$` · indoor · hands-on
...
### 🍴 Kid-Friendly Food
- [Serendipity 3](restaurant-serendipity-ues.md) — `$$` · Frozen Hot Chocolate
...
- [Central Park Carousel](attraction-central-park-carousel.md) — `$` · classic carousel

## [Chelsea](neighborhood-chelsea.md)
...
### 🍴 Kid-Friendly Food
- [Shake Shack (Madison Square Park)](restaurant-shake-shack-madison-sq.md) — `$$` · burgers · the original

## [Hell's Kitchen](neighborhood-hells-kitchen.md)

### 🎨 Museums
- [Intrepid Museum](museum-intrepid.md) — `$$$` · planes + space shuttle

## [Battery Park City](neighborhood-battery-park-city.md)
...
### 📚 Library Story Times
- [NYPL Toddler Story Time](event-storytime-nypl.md) — free · indoor · recurring · branches everywhere

## Relationships
- Back to the [homepage](../index.md) · other boroughs: [Brooklyn](borough-brooklyn.md) · [Queens](borough-queens.md) · [The Bronx](borough-bronx.md) · [Staten Island](borough-staten-island.md)
